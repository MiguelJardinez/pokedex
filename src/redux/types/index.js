...
//Obtener favoritos storage
export const FAVORITOS_STORAGE = 'FAVORITOS_STORAGE';
export const FAVORITOS_STORAGE_EXITO = 'FAVORITOS_STORAGE_EXITO';
export const FAVORITOS_STORAGE_ERROR = 'FAVORITOS_STORAGE_ERROR';
